                ...
                TabView(selection: $selectedTab) {
                    ...
                    NavigationStack {
                        if userManager.isLogin {
                            BookShelfView(userId : userManager.uid,initialTapInfo: .wish, isBack: false,isShowPlusBtn: $isShowPlusBtn)
                                .onDisappear {
                                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                                        shouldShowActionSheet = false
                                    }
                            ...
                            BookShelfView(userId: nil,initialTapInfo: .wish, isBack: false, isShowPlusBtn: $isShowPlusBtn)
                                .onDisappear {
                                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                                        shouldShowActionSheet = false
                                    }
